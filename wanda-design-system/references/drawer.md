...
## Notes
- **Rounded**-варіант досліджено: радіус завжди на боці, **протилежному від екранного краю**, до якого прилягає панель — Position=Left → заокруглюються праві кути (`rounded-tr/br`); Position=Right → заокруглюються ліві кути (`rounded-tl/bl`). Прилеглий до краю екрана бік завжди лишається прямим.
